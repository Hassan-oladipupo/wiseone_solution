app.controller('ApproveLeaveCtrl', function($scope, configFileService, $modal, $sessionStorage) {
    ...
    $scope.approveordecline = function(data) {
        ...
        var modalInstance = $modal.open({
            backdrop: false,
            keyboard: true,
            templateUrl: 'views/leave/leavemodal.html',
        ...
        modalInstance.result.then(function(leaveRequest) {
            ...
            if (leaveRequest.update) {
                ...
                configFileService
                    .put(configFileService.apiHandler.approveLeaveRequest, leaveRequest)
                    .success(function(data, status, headers) {
