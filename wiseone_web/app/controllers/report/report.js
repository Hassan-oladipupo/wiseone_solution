app.controller('ReportCtrl', function($scope, configFileService, $modal, $sessionStorage) {
    ...
    $scope.search = function() {
        ...
        var uri = configFileService.apiHandler.retrieveReportSummary;
    ...
    var initChart = function(reports) {

        _.forEach(reports, function(r, rkey) {
            reports[rkey].RealDate = (moment(r.Date, "DD/MM/YYYY")).toDate();
        });
        ...
        $scope.reports.dataset0 = reports;
    ...
    $scope.viewdetails = function(data) {
        ...
        var modalInstance = $modal.open({
            templateUrl: 'views/report/reportmodal.html',
