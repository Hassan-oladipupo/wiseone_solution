app.controller('UpdateShiftCtrl', function($scope, configFileService, $modal, $sessionStorage, confirmService, $state) {
            ...
            var table = $shiftList.DataTable({
                ...
                columns: [
                    ...
                    { "data": "LastUpdatedOn" },
                    {
                        ...
                        "orderable": false,
                        "data": null,
                        "defaultContent": '<i title="Update Shift" class = "fa fa-edit themeprimary bordered-themeprimary dt-icon"></i>'
                    },
                    {
                        "data": "ID",
                        "visible": false
    ...
    $scope.confirmEdit = function(data) {
        ...
        var modalOptions = {
            headerText: 'Modify Shift: ' + data.WeekName + '?',
            bodyText: 'Are you sure you want to modify this Shift?'
        };
