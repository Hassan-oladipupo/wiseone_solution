app.controller('LeaveModalCtrl',
    function($scope, $filter, $modalInstance, leaveDto, configFileService) {
        ...
        $scope.approvalType = $scope.leave.Approval.ApprovalStatus == 'Pending' ? '' : $scope.leave.Approval.ApprovalStatus == 'Approved' ? 'Approve' : $scope.leave.Approval.ApprovalStatus == 'Acknowledged' ? 'Approve' : 'Decline';
