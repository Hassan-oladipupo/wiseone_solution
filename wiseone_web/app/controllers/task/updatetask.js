app.controller('UpdateTaskCtrl', function($scope, configFileService, $modal, $sessionStorage, confirmService, $state) {
    ...
    var initTaskList = function(tasks) {
        ...
        if ($.fn.DataTable.isDataTable('#taskList')) {
            ...
            var table = $taskList.DataTable({
                ...
                columns: [
                    ...
                    { "data": "Status" },
                    {
                        ...
                        "orderable": false,
                        "data": null,
                        "defaultContent": '<i title="Update Task" class = "fa fa-edit themeprimary bordered-themeprimary dt-icon"></i>'
                    }
                ],
                order: [
                    [3, "desc"]
            ...
            $taskList.find('tbody').on('click', 'td.edit', function() {
    ...
    $scope.confirmEdit = function(data) {
        ...
        var modalOptions = {
            headerText: 'Modify Task: ' + data.Subject + '?',
            bodyText: 'Are you sure you want to modify this Task?'
        };
